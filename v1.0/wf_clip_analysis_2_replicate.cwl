...
outputs:
  ...
  annotated_rep1_peaks_file:
    type: File
    outputSource: step_rep1_clip_analysis/output_annotated_file
  annotated_rep2_peaks_file:
    type: File
    outputSource: step_rep2_clip_analysis/output_annotated_file
  annotated_merged_peaks_file:
    type: File
    outputSource: step_annotate_idr_peaks/output_annotated_file
...
steps:
  ...
  step_plot_clip_analysis_figures:
    ...
    in:
      ...
      annotated_files: [
        step_annotate_idr_peaks/output_file,
        step_rep1_clip_analysis/output_annotated_file,
        step_rep2_clip_analysis/output_annotated_file
      ]
